...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        // === DXF 頁籤：瀏覽 / 載入 / 打標 / 預覽方法已移至 Form1.Dxf.cs ===
        // 以下 btnStopPreview_Click / timerPreview_Tick / ResetPreviewButtonsAfterStop
        // 為跨頁籤共用的預覽基礎設施，保留於此。
        ...
        // === 命令提示頁籤：產生 / 執行方法已移至 Form1.CmdPreview.cs ===
        ...
        // === 命令頁籤 Timer / 並行驗證方法已移至 Form1.CmdPreview.cs ===

        // === DXF: 停止打標 / 清除 / 解析方法已移至 Form1.Dxf.cs ===
        ...
        // === 雷射功率頁籤 UI 方法已移至 Form1.LaserParams.cs ===

        // === QR Code 頁籤 + 白底 QR 建立 / 打標方法已移至 Form1.QrWhiteBg.cs ===

        // === 白底 QR 建立 / 打標方法（btnQRWhiteBg* / ExecuteQRWhiteBg）已移至 Form1.QrWhiteBg.cs ===

        // === 序號 helper / 參數記錄 / 鋼鐵 Quest3 QR 方法已移至 Form1.QrSteel.cs ===

        // === 6-1 QR Code 頁（打黑/打白/單打QR/三合一）+ 鋼鐵Quest3 停止 + 矩形獨立/QR獨立
        //     方法已移至 Form1.TabQR2.cs ===

        // === CLI Builder 頁籤（方法已移至 Form1.CliBuilder.cs）===
